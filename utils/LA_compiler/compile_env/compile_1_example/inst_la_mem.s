...
_start:
    ...
    # 内存操作序列
    st.w $r1, $r0, 0       # mem[0]=R1=36      
    st.w $r4, $r0, 4       # mem[1]=R4=4       
    st.w $r6, $r0, 8       # mem[2]=R6=6       
    ld.w $r4, $r0, 0       # R4=mem[0]=36      
    st.w $r4, $r0, 12      # mem[3]=R4=36      
    ld.w $r4, $r0, 4       # R4=mem[1]=4       
    ld.w $r4, $r0, 12      # R4=mem[3]=36      
    st.w $r6, $r0, 0       # mem[0]=R6=6       
    ld.w $r6, $r0, 12      # R6=mem[3]=36      
    st.w $r6, $r6, 0       # mem[36]=36        
    ld.w $r4, $r6, 0       # R4=mem[36]=36     
    st.w $r5, $r0, 0       # mem[0]=R5=5       
    ld.w $r5, $r0, 0       # R5=mem[0]=5       
    ld.w $r6, $r0, 0       # R6=mem[0]=5       
    ld.w $r4, $r0, 4       # R4=mem[1]=4       
    ld.w $r6, $r0, 8       # R6=mem[2]=6       
